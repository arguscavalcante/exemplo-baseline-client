...
angular
    ...
    .controller('relatorioCtrl', ['$scope', '$state', 'LimiteGrafico', 'Projeto', function($scope, $state, LimiteGrafico, Projeto){
        ...
        LimiteGrafico.find().$promise.then(function(res, err){
            $scope.limgraf = res;
            objChartProj.limite = atribuirvalor();
            objChartProj.limite_neg = calcularvalorposneg(objChartProj.limite, -5);
            objChartProj.limite_pos = calcularvalorposneg(objChartProj.limite, 5);
        ...
        function atribuirvalor(){
            ...
            var valorAntigo = $scope.limgraf[0].valor_limite;
            var indice = 0;
         ...
         function calcularvalorposneg(valor, indicador){
            ...
            angular.forEach(valor, function(value, index){
                console.log(valor[indice][1] + (valor[indice][1] * (indicador /100)));
